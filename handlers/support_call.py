...
from keyboard.inline_support import support_keyboard, support_callback, check_support_available, get_support_manager, \
...
def get_support_call(dp: Dispatcher):
    dp.register_message_handler(ask_support_call, Text(equals='Онлайн консультация'))
